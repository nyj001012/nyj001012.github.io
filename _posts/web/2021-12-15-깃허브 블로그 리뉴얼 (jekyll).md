...
혹시 다른 포스트도 다 댓글창이 없나 싶어서 살펴보니까 어제 올린 ['성장에 한계를 느끼는 순간, 스스로 돌파구를 찾는 개발자가 되려면'](../lecture/2021-12-21-돌파구를%20찾는%20개발자가%20되려면.md) 포스트만 '댓글 남기기'라는 문구만 남아있었다.
...
errors:
  ...
  resource: "Search"
```
느낌이 온다. message는 에러 메시지 내용인데, 내가 집중해서 본 부분은 다음과 같다.  
'search가 256글자보다 길다.'  
